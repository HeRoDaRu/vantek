  ...
  return (
    <aside style={{
      ...
      <nav style={{ flex: 1, padding: '10px 8px', display: 'flex', flexDirection: 'column', gap: 2, overflowY: 'auto' }}>
        ...
        <NavItem to="/clientes"     icon={<IconClientes />}     label={t('clientes')}         collapsed={collapsed} />
        ...
        {modulos.seguimiento && (
          <NavItem to="/seguimiento" icon={<IconSeguimiento />} label={t('trabajos')}         collapsed={collapsed} />
        )}
      </nav>
